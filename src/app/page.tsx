  ...
  return (
    <main>
      ...
      {showSessionExpiredNotice && (
        <div className="fixed top-20 left-0 right-0 z-50 mx-auto max-w-2xl px-4">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 flex-1">
                ...
                <p className="mt-1 text-sm text-yellow-700">
                  You were signed out in another tab or your session timed out. Please sign in again to continue.
                </p>
              </div>
